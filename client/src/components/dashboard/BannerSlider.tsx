  ...
  return (
    <section className="relative h-72 overflow-hidden sm:h-80 lg:h-[440px]">
      {slides.map((s, i) => (
        ...
        >
          ...
          <div className="mx-auto flex h-full max-w-7xl flex-col justify-center px-6 lg:px-8">
            <p className="text-sm font-medium text-white/85" suppressHydrationWarning>
              {s.eyebrow}
            </p>
      ...
      <button
        ...
        className="absolute left-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/25 text-white backdrop-blur transition-colors hover:bg-white/40 lg:left-6"
      >
      ...
      <button
        ...
        className="absolute right-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/25 text-white backdrop-blur transition-colors hover:bg-white/40 lg:right-6"
      >
