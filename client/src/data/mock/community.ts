...
export const mockCommunity: CommunityPost[] = [
  {
    ...
    body: "Started in Tokyo, ended in Kyoto. The temples at dawn were unreal. Budget worked out to about ₹1.4L including flights — totally worth it.",
    likes: 342,
    comments: 48,
    postedAt: "2 days ago",
  },
  ...
  },
  {
    ...
    body: "Spent an evening rolling fresh pasta with a local nonna. Best ₹6.5k I spent in Italy — and I still make the carbonara at home.",
    likes: 410,
    comments: 55,
